...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    private int ASPECT_RATIO_X = 16, ASPECT_RATIO_Y = 9, bitmapMaxWidth = 900, bitmapMaxHeight = 900;
    ...
    private void cropImage(Uri sourceUri) {
        ...
        options.setActiveControlsWidgetColor(ContextCompat.getColor(this, R.color.white_pure));
